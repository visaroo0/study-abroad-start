      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {services.map((service) => (
            ...
            >
              <div className="w-12 h-12 rounded-xl bg-gradient-glass flex items-center justify-center mb-4 group-hover:bg-gradient-hero transition-colors duration-300">
