...
const testimonials = [
  {
    name: "Priya Sharma",
    country: "India → USA",
    text: "Visaroo made my F-1 visa process incredibly smooth. I got my visa approved on the first attempt! The team was supportive every step of the way.",
    rating: 5,
  },
  {
    name: "Ahmed Hassan",
    country: "Egypt → UK",
    text: "I was overwhelmed with the Tier 4 visa requirements, but Visaroo simplified everything. Their interview prep was a game-changer.",
    rating: 5,
  },
  {
    name: "Li Wei",
